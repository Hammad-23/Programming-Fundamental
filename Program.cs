...
namespace ConsoleApp2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //double obtainedMarks = (double)marks1 + (double)marks2 + (double)marks3;
            //double percentage = (obtainedMarks / 300) * 100;
            //Console.WriteLine("percentage is--> {0}", percentage + "%");

            //bool prob1 = percentage >= 80;
            //bool prob2 = percentage >= 70 && percentage < 80;
            //bool prob3 = percentage >= 60 && percentage < 70;
            //bool prob4 = percentage >= 50 && percentage < 60;
            //bool prob5 = percentage >= 40 && percentage < 50;


            //switch (true)
            //{
            //    case prob1:
            //        Console.WriteLine("You got A1");
            //        break;
            ...
            //char check = per < 50 ? 'f' : per >= 50 && per < 60 ? 'c' : 'b';
            ...
            //double worth = Convert.ToDouble(Console.ReadLine());
            //double zakat = worth * (2.5 / 100);
            //Console.WriteLine("You have to pay {0} for zakat", zakat);
            ...
            //Console.WriteLine("Enter miles value");
            //double miles = Convert.ToDouble(Console.ReadLine());
            //double meters = miles * 1609.4;
            //Console.WriteLine("value in meter is {0}", meters);
            ...
            //double allowance = (basicSalary / 100) * 40;
            //Console.WriteLine("allowance--> {0}", allowance);
            //double rent = (basicSalary / 100) * 20;
            //Console.WriteLine("rent--> {0}", rent);
            //double grossSalary = basicSalary + allowance + rent;
            ...
            //Console.WriteLine("please enter mass of an object");
